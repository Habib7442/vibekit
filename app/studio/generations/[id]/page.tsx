                       ...
                       {img.prompt && (
                         <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-black via-black/80 to-transparent translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                            ...
                            <div className="mt-4 flex gap-2">
                               <a href={img.image_url} download target="_blank" className="p-2 rounded-lg bg-white/10 hover:bg-white/20 text-white transition-all">
                                  <Download size={14} />
                               </a>
                            </div>
                         </div>
       ...
       <div className="shrink-0 h-16 border-b border-white/[0.04] bg-[#0A0A0F]/50 flex items-center justify-between px-6">
          <div className="flex items-center gap-4">
             ...
             <span className={cn(
               ...
               canvas.type === 'app' ? "bg-cyan-500/10 border-cyan-500/20 text-cyan-400" : "bg-amber-500/10 border-amber-500/20 text-amber-400"
             )}>
                {canvas.type === 'app' ? 'App UI' : 'Landing Page'}
             </span>
          </div>
                ...
                {screens.map((screen) => (
                  <div key={screen.id} className="flex flex-col gap-6">
                     <div className="flex items-center justify-between">
                        ...
                        <button className="p-2 rounded-lg bg-zinc-900 border border-zinc-800 text-zinc-500 hover:text-white transition-all flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest">
                           <Copy size={12} />
                           Code
                        </button>
                     </div>
